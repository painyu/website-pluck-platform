...
import com.website.pluck.platform.modules.job.mapper.ScheduleJobMapper;
...
import com.website.pluck.platform.modules.job.utils.ScheduleUtils;
...
public class ScheduleJobServiceImpl extends ServiceImpl<ScheduleJobMapper, ScheduleJob> implements ScheduleJobService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        ...
        IPage<ScheduleJob> page = this.page(new Query<ScheduleJob>().getPage(params), new QueryWrapper<ScheduleJob>().like(StringUtils.isNotBlank(beanName), "bean_name", beanName));
