...
import com.website.pluck.platform.modules.sys.mapper.SysConfigMapper;
import com.website.pluck.platform.modules.sys.model.SysConfig;
import com.website.pluck.platform.modules.sys.redis.SysConfigRedis;
import com.website.pluck.platform.modules.sys.service.SysConfigService;
...
public class SysConfigServiceImpl extends ServiceImpl<SysConfigMapper, SysConfig> implements SysConfigService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        ...
        IPage<SysConfig> page = this.page(new Query<SysConfig>().getPage(params), new QueryWrapper<SysConfig>().like(StringUtils.isNotBlank(paramKey), "param_key", paramKey).eq("status", 1));
